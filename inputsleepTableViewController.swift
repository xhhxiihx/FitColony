//
//  inputsleepTableViewController.swift
//  FitColony
//
...
class inputsleepTableViewController: UITableViewController {
    ...
    @IBAction func sleepdatepickerValueChange(sender: AnyObject) {
        ...
        var timeinterval:NSTimeInterval=hourformat.dateFromString(end!)!.timeIntervalSinceDate(hourformat.dateFromString(start!)!)
    ...
    override func viewDidLoad() {
        ...
        currentdate=dateformat.dateFromString(dayformat.stringFromDate(NSDate())+" 00:00")!
        duration=0.0
